...
const PrivacyPolicy = () => {
  const text = `Effective date: January 2, 2023

  This Privacy Policy (the “Policy”) describes how Wonder Store US (referred to in this Privacy Policy as “Company,” “we,” “us,” or “our”), as the developer of the BuyCode mobile application (the “App”), collects information when you use the App. This Policy also explains how we use and disclose the information we collect from you, and your rights in relation to that information.
  ...
  11. Special Notice to Individuals in the European Economic Area, Switzerland and/or the United Kingdom
  ...
  A. Our Relationship to You. Wonder Store US LLC is a data controller with regard to any personal information collected from individuals accessing or using its Service. A “data controller” is an entity that determines the purposes for which and the manner in which any personal information is processed. Any third parties that act as our service providers or are otherwise acting on our behalf are “data processors” that handle your personal information in accordance with our instructions.
  ...
  Right to Lodge Complaints. If you believe that we have infringed or violated your privacy rights under applicable law or this Policy, please contact us at support@mywonderhaus.com, so that we can work with you to resolve your concerns. You also have a right to lodge a complaint with a competent supervisory authority situated in a Member State of your habitual residence, place of work, or place of alleged infringement.
  
  12. How to Contact Us
  
  Please also feel free to contact us at support@mywonderhaus.com if you have any questions about this Privacy Policy.`;
  return (
    <ScrollView
